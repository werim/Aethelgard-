...
- Package version remains `0.22.0` for Gate 5A-2 through Gate 5A-6.
...
- `UNAVAILABLE`: Gate 5A-6 connector-visible CI remains UNAVAILABLE and user-reported green validation evidence is not connector-visible workflow evidence.
