...
| Gate 2B current-Black follow-up | Installed current allowed Black `26.5.1` locally and applied its formatter diff for `list_audit_events`; functional behavior unchanged | `CHANGED`; pending rerun |
